...
var MAX_LEVEL = 30;
var TIBO_RANKS = ["\u5C0F\u96BETibo", "\u7262Tibo", "Tibo\u5B50", "Tibo\u5723", "Tibo\u795E", "Tibo\u7956"];
var STOPS = [
...
function tiboRankForFrame(rawFrame) {
...
function indicatorLabel(rawFrame, efforts) {
  ...
  return effort === void 0 ? tiboRankForFrame(rawFrame) : `${tiboRankForFrame(rawFrame)} \xB7 ${effort.name}`;
}
...
function installLiangAppearanceButton(scope, presenter) {
  ...
  const sync = () => {
    ...
    if (customButton === null) {
      ...
      label.textContent = document.documentElement.lang.toLowerCase().startsWith("en") ? "Tibo Reset" : "Tibo Reset";
    ...
    if (!snapshot.enabled) {
      ...
      const bindingText = document.documentElement.lang.toLowerCase().startsWith("en") ? "Bind Tibo Reset to reasoning level" : "Tibo Reset \u7ED1\u5B9A\u601D\u8003\u7B49\u7EA7";
